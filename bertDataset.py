...
if __name__=="__main__":
    ...
    # print("total data: %d" %len(data_set))
    # dataLoader = DataLoader(data_set,batch_size=64,shuffle=False,sampler=sampler)
    ...
    print(len(data_set))
    # for train_index,test_index in kf.split(range(len(data_set))):
    #     print(train_index)
