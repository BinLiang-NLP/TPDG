...
def process(filename, seedname):
    ...
    fin.close()
    idx2graph = {}
    fout = open(filename+'.graph.stance.3way11t', 'wb')
    graph_idx = 0
...
if __name__ == '__main__':
    # process('./raw_data/fm.raw', './seed_words/seed_word.domain.FM.stance.3way11.tf')
    # process('./raw_data/la.raw', './seed_words/seed_word.domain.LA.stance.3way11.tf')
    # process('./raw_data/dt.raw', './seed_words/seed_word.domain.DT.stance.3way11.tf')
    # process('./raw_data/hc.raw', './seed_words/seed_word.domain.HC.stance.3way11.tf')
    process('./raw_data/tp.raw', './seed_words/seed_word.domain.TP.stance.3way11.tf')
    process('./raw_data/hc.raw', './seed_words/seed_word.domain.HC.stance.3way11.tf')
